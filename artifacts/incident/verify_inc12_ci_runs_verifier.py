...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # NEW CI reddens if the suite reddens OR the verifier reddens; but for the
        # DIVERGENCE claim we require the verifier to have reddened *specifically*
        # on its mutation witness.
